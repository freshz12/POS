        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col">
                            <label for="product_name_filter" class="form-label">Product Name</label>
                    ...
                    <div class="row">
                        <div class="col">
                            <label for="quantity_left_filter" class="form-label">Remaining Quantity</label>
                            <input class="form-control" type="number" id="quantity_left_filter"
                                name="quantity_left_filter">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <label for="total_sold_quantity_filter" class="form-label">Total Sold Quantity</label>
                            <input class="form-control" type="number" id="total_sold_quantity_filter"
                                name="total_sold_quantity_filter">
                        </div>
                    </div>
                </div>
...
@push('scripts')
    @include('pages.dashboards.products.js.products-js')
@endpush
