...
@section('main')
                                    ...
                                    <div class="d-flex mb-3" style="flex-grow: 1; align-items: flex-end;">
                                        @can('attendances_create')
                                            <button style="max-height: 40px; display: flex; align-items: center;"
                                                class="btn btn-primary" data-toggle="modal" data-target="#addattendance">
                                    ...
                                    <table class="table-hover table" id="datatable" style="width: 100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col">Approved or Rejected Reason</th>
    ...
    {{-- Modal Create --}}
    <div class="modal fade" tabindex="-1" role="dialog" id="addattendance">
        <div class="modal-dialog modal-dialog-centered modal" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Request New Attendance <br>
                        <br>
                    </h5>
                ...
                <form method="post" action="{{ url('/attendances/store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input class="form-control flatpickr" type="text" name="clock_in" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input class="form-control flatpickr" type="text" name="clock_out" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" type="text" rows="3" name="request_reason" required></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="editattendance">
        <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Edit Attendance <br>
                        <br>
                    </h5>
                ...
                <form method="post" action="{{ url('/attendances/update') }}" enctype="multipart/form-data"
                    id="editForm">
                    @csrf
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    <label for="request_reason" class="form-label">Request Reason</label>
                                    <textarea class="form-control" type="text" id="request_reason" rows="3" name="request_reason" required></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal fade" tabindex="-1" role="dialog" id="filterattendance">
        <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Filter Attendance <br>
                        <br>
                    </h5>
...
@push('scripts')
    @include('pages.attendances_table.js.attendances-table-js')
@endpush
